    ...
    return (
        <div className="bg-brand-gray-50">
            ...
            <div className="relative bg-techflex-blue text-white py-24 sm:py-32">
                <div className="absolute inset-0 bg-cover bg-center opacity-10" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1542831371-29b0f74f9713?auto=format&fit=crop&q=80')" }}></div>
                <div className="absolute inset-0 bg-gradient-to-b from-techflex-blue/90 to-techflex-blue"></div>
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
                    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight">Bespoke Software Development</h1>
                    ...
                    <div className="max-w-4xl mx-auto bg-white p-10 rounded-2xl shadow-xl border border-brand-gray-200">
                        {techCategories.map((cat, index) => (
                             <div key={cat.name} className={`flex flex-col sm:flex-row gap-4 items-start sm:items-center py-4 ${index < techCategories.length - 1 ? 'border-b border-brand-gray-100' : ''}`}>
                                <h3 className="w-full sm:w-1/4 font-bold text-techflex-blue-700 text-lg flex-shrink-0">{cat.name}</h3>
            ...
            <section id="contact" className="bg-techflex-blue">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
                    <div className="text-center text-white">
                        <h2 className="text-4xl font-extrabold tracking-tight">Ready to build your next big idea?</h2>
